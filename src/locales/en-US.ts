export default {
    ...
    'liquidity.bs.price': 'BST Price',
    'liquidity.bs.vol': 'BST Vol',
    'liquidity.bs.circulatingsupply': 'BST Circulating Supply',
    ...
    'assetsbar.lockedtoken': 'Locked BST',
    ...
    'footer.ftoken.price': 'BST Price',
    'footer.ftoken.button': 'Buy BST',
    ...
    rewards: 'Rewards',
    rewardsTip:
        'Rewards come from BST locked in the Mint, 50% can be withdrawn immediately, and 50% will be released linearly within 30 days',
    ...
    doBurn: 'Burn',
    locked: 'Locked',
    lockedTip: 'Select the proportion of BST in pledge tokens',
    lockedDetailTip:
        'The higher the proportion of BST you locked, the lower the F-ratio, which can be as low as 350%',
    fratioTip:
    ...
    mintCommentaryDesc:
        "To lock single-currency or LP tokens consisted of BST as collateral to mint IronForge's synthetic asssts(fAssets)",
